                    ...
                    if( strpos( $field_name, 'td_source_title' ) === 0) {
                        ...
                        if (!empty($td_custom_cat_name)) {
                            if ($field_name == 'td_custom_cat_name_url') {
                                ...
                                $custom_field_data['value'] .= !empty($td_custom_cat_name_url) ? '<a href="' . esc_url($td_custom_cat_name_url) . '">' : '';
                            }
                            $custom_field_data['value'] .= $td_custom_cat_name;
                            if ($field_name == 'td_custom_cat_name_url') {
                                $custom_field_data['value'] .= !empty($td_custom_cat_name_url) ? '</a>' : '';
                            }
                            $custom_field_data['type'] = 'text';
                            $custom_field_data['meta_exists'] = true;
            ...
            $buffy .= '<div class="tdb-block-inner td-fix-index">';
                ...
                if( $custom_field_data['type'] == 'image' ) {
                    ...
                    if ( $display_list && ( $custom_field_data['type'] == 'checkbox' || $custom_field_data['type'] == 'select' ) ) {
                        ...
                        if( $url != '' && self::$field_type != 'wysiwyg' ) {
