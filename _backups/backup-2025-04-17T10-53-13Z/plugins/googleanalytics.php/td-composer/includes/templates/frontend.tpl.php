                    ...
                    if ( 'module' === $tdbTemplateType ) {
						...
						if ( !empty( $multipurpose_mapped_shortcodes ) ) {
		                    ...
		                    foreach ( $multipurpose_mapped_shortcodes as $mapped_shortcode ) {
								...
								if(
									...
									$mapped_shortcode['base'] === 'tdm_block_column_title_simplified' ||
									$mapped_shortcode['base'] === 'tdm_block_icon' ||
									$mapped_shortcode['base'] === 'tdm_block_inline_text_simplified' ||
	                    ...
	                    if ( !empty( $multipurpose_mapped_shortcodes ) ) {
		                    ...
		                    foreach ( $multipurpose_mapped_shortcodes as $mapped_shortcode ) {
								...
								if ( in_array( $mapped_shortcode['base'], array('tdm_block_column_title', 'tdm_block_inline_text') ) ) {
									continue;
								}
